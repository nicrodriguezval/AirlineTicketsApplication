...
public class ReservationVuelta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelPrincipal.add(horaCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 220, 70, 30));
        ...
        panelPrincipal.add(equipajeCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, -1, -1));

        pesoEquipaje.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        pesoEquipaje.setText("Peso del equipaje");
        panelPrincipal.add(pesoEquipaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, 137, 43));
        ...
        panelPrincipal.add(pesoEquipajeCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, 94, -1));
        ...
        panelPrincipal.add(cancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 240, 120, -1));
        ...
        panelPrincipal.add(siguiente, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 240, -1, -1));

        origenVuelta.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        panelPrincipal.add(origenVuelta, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 170, 30));

        destinoVuelta.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        panelPrincipal.add(destinoVuelta, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 140, 160, 30));
        ...
        panelPrincipal.add(fechaCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 140, 70, 30));

        noPuestosL.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        panelPrincipal.add(noPuestosL, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 170, 30));

        categoriaL.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        panelPrincipal.add(categoriaL, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 140, 170, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ReservVuelta.png"))); // NOI18N
        panelPrincipal.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 350));

        getContentPane().add(panelPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 860, 290));
